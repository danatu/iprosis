sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("iprosistest/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("iprosistest.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["iprosistest/localService/mockserver"], function (mockserver) {
