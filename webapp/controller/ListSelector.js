sap.ui.define([
		...
		return BaseObject.extend("iprosistest.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias iprosistest.model.ListSelector
			 */
			 ...
			 * @return {iprosistest.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
